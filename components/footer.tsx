        ...
        <div className="grid gap-14 md:grid-cols-3 pb-16 md:pb-20 border-b border-white/10">
          ...
          <div className="space-y-6 text-center md:text-left">
            ...
            <p className="mx-auto md:mx-0 max-w-sm text-sm leading-relaxed text-white/60">
              Blending aesthetics with engineering to craft web interfaces that
              not only work — they captivate and inspire.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center justify-center text-center gap-8">
            <p className="max-w-sm text-sm leading-relaxed text-white/60">
              Let’s stay connected — I post dev notes, design experiments,
