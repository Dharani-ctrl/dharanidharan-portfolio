...
export default function Education() {
  ...
  return (
    <section id="education" className="py-24 px-4 bg-[#030712] relative overflow-hidden">
          ...
          <div className="space-y-12">
            {education.map((edu, idx) => (
              ...
              >
                ...
                <div className="absolute left-4 md:left-1/2 md:-translate-x-1/2 w-10 h-10 rounded-full bg-[#030712] border-2 border-blue-500 flex items-center justify-center z-20 shadow-[0_0_15px_rgba(59,130,246,0.3)]">
                  <div className="text-blue-400">{edu.icon}</div>
                </div>

                {/* Content Card */}
                <div className="w-full md:w-[45%] pl-12 md:pl-0">
                  <div className="group relative p-6 rounded-2xl bg-white/[0.02] border border-white/10 backdrop-blur-sm hover:border-blue-500/40 hover:bg-white/[0.04] transition-all duration-500">
